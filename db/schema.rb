...
ActiveRecord::Schema.define(version: 2019_10_23_081055) do
  ...
  create_table "tour_dairies", force: :cascade do |t|
    t.string "qrcode_image"
    t.text "content"
    t.bigint "wine_review_id"
    t.bigint "user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_tour_dairies_on_user_id"
    t.index ["wine_review_id"], name: "index_tour_dairies_on_wine_review_id"
  end
  ...
  create_table "tours", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["winery_id"], name: "index_tours_on_winery_id"
  end
  ...
  create_table "wineries", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["wine_id"], name: "index_wineries_on_wine_id"
  end
  ...
  create_table "wines", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["food_id"], name: "index_wines_on_food_id"
  end

  add_foreign_key "bookings", "tours"
  add_foreign_key "bookings", "users"
  add_foreign_key "tour_dairies", "users"
  add_foreign_key "tour_dairies", "wine_reviews"
  add_foreign_key "tours", "wineries"
  add_foreign_key "wine_reviews", "wines"
  add_foreign_key "wineries", "wines"
  add_foreign_key "wines", "foods"
end
